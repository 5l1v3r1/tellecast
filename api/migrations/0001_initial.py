    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.URLField(db_index=True, max_length=255, null=True, verbose_name='Photo', blank=True)),
                ...
                ('date_of_birth', models.DateField(null=True, verbose_name='Date of Birth', db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('photo', models.URLField(db_index=True, max_length=255, verbose_name='Photo', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(db_index=True, max_length=255, null=True, verbose_name='URL', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('string', models.URLField(max_length=255, verbose_name='String', db_index=True)),
                ('position', models.IntegerField(verbose_name='Position', db_index=True)),
